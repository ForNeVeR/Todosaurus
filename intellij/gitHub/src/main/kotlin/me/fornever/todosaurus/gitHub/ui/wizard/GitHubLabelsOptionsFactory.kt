...
package me.fornever.todosaurus.gitHub.ui.wizard
...
class GitHubLabelsOptionsFactory(private val scope: CoroutineScope) : IssueOptionsFactory {
    ...
    override fun createIssueOptions(project: Project, model: TodosaurusWizardContext<ToDoItem.New>): IssueOptions
        = GitHubLabelsOptions(scope, project, model)
}
